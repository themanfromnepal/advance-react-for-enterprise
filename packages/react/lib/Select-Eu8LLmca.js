...
import { T as Text } from './Text-DIUDjvih.js';
...
const Select = ({ options = [], label = "Please select an option ...", onOptionSelected: handler, renderOption, }) => {
    ...
    return (React.createElement("div", { className: "dse-select" },
        React.createElement("button", { "data-testid": "DseSelectButton", onKeyDown: onButtonKeyDown, "aria-controls": isOpen ? "dse-select-list" : undefined, "aria-haspopup": true, "aria-expanded": isOpen, ref: labelRef, className: "dse-select__label", onClick: () => onLabelClick() },
        ...
        React.createElement("ul", { role: "menu", "aria-hidden": !isOpen, id: "dse-select-list", style: { top: overlayTop }, className: `dse-select__overlay ${isOpen ? "dse-select__overlay--open" : ""}` }, options.map((option, optionIndex) => {
...
export { Select as S };
//# sourceMappingURL=Select-Eu8LLmca.js.map
